...
import static com.piccjm.piccdemo.app.AppConstants.STATE_EMPTY;
import static com.piccjm.piccdemo.app.AppConstants.STATE_ERROR;
import static com.piccjm.piccdemo.app.AppConstants.STATE_LOADING;
import static com.piccjm.piccdemo.app.AppConstants.STATE_SUCCESS;
import static com.piccjm.piccdemo.app.AppConstants.STATE_UNKNOWN;
...
public abstract class LoadingPage extends FrameLayout {
    ...
    private AnimationDrawable mAnimationDrawable; // 用于控制帧动画的类

    private ImageView img;

    public int state = STATE_UNKNOWN; // 未知的状态 默认显示加载中的contentView
    ...
    private void init() {
        this.setBackgroundColor(getResources().getColor(R.color.colorPageBg)); // 设置背景颜色
    ...
    private View createLoadingView() {
        ...
        // 获取loadingView中的image,并且本身的src就是一个imageList,可以播放动画
